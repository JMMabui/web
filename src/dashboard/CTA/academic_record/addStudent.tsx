...
export function AddStudents() {
    ...
    return (
      <div className="sm:col-span-2">
        ...
        <div className="mt-2">
          ...
          />
          {errors[id] && (
            <ErrorMessage error={{ message: errors[id]?.message }} />
          )}
        </div>
      </div>
    )
  ...
  return (
    <div className="w-full mt-10 sm:mx-auto mx-auto sm:w-full sm:max-w-2xl text-left border-b border-gray-900/10 pb-12">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mt-5">
          ...
          <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 mt-4">
            ...
            {renderSelectField('marital', 'Estado Civil', [
              'SOLTEIRO',
              'CASADO',
              'DIVORCIADO',
              'VIUVO',
        ...
        <div className="mt-5">
          ...
          <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 mt-4">
            {renderSelectField('documentType', 'Tipo de Documento', [
              'BI',
              'PASSAPORTE',
            ])}
            {renderInputField(
        ...
        <div className="mt-5">
          ...
          <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 mt-4">
            {renderSelectField('provincyAddress', 'Província', [
              'MAPUTO_CIDADE',
              'MAPUTO_PROVINCIA',
              'GAZA',
              'INHAMBANE',
